...
namespace Project {
    ...
    public partial class TimetableDataSet : global::System.Data.DataSet {
        ...
        public partial class TimetableDataTable : global::System.Data.TypedTableBase<TimetableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TimetableRow AddTimetableRow(string Subject, string Grade, string Time, string Day, int Hallno, string TeacherName) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TimetableRow FindByclassId(int classId) {
        ...
        public partial class TimetableRow : global::System.Data.DataRow {
            ...
            public int classId {
                get {
                    return ((int)(this[this.tableTimetable.classIdColumn]));
                }
                set {
            ...
            public string Grade {
                get {
                    return ((string)(this[this.tableTimetable.GradeColumn]));
                }
                set {
            ...
            public int Hallno {
                get {
                    return ((int)(this[this.tableTimetable.HallnoColumn]));
                }
                set {
                    this[this.tableTimetable.HallnoColumn] = value;
                }
            }
...
namespace Project.TimetableDataSetTableAdapters {
    ...
    public partial class TimetableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Timetable] WHERE (([classId] = @Original_classId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Timetable] ([Subject], [Grade], [Time], [Day], [Hallno], [Teac" +
                "herName]) VALUES (@Subject, @Grade, @Time, @Day, @Hallno, @TeacherName)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Timetable] SET [Subject] = @Subject, [Grade] = @Grade, [Time] = @Ti" +
                "me, [Day] = @Day, [Hallno] = @Hallno, [TeacherName] = @TeacherName WHERE (([clas" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT classId, Subject, Grade, Time, Day, Hallno, TeacherName FROM dbo.Timetable" +
                "";
        ...
        public virtual int Insert(string Subject, string Grade, string Time, string Day, int Hallno, string TeacherName) {
            if ((Subject == null)) {
        ...
        public virtual int Update(string Subject, string Grade, string Time, string Day, int Hallno, string TeacherName, int Original_classId) {
            if ((Subject == null)) {
                throw new global::System.ArgumentNullException("Subject");
            }
            else {
            ...
            if ((TeacherName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(TeacherName));
            }
